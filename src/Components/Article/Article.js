...
function Article() {
  return (
    <Container maxWidth="md">
      <article>
        <p>
          <strong>This is a map of sexual abuse committed by Roman Catholic priests and brothers who belonged to the Society of Jesus.</strong>
        </p>
        <p>
        ...
        <p>
          <em>Desolate Country</em> is a map built from information on the Jesuits West list. This includes names of priests and brothers, places they lived and worked, and years during which they abused.
        </p>
        <p>
          The Western Province list is one of nearly  <a href="https://www.bishop-accountability.org/AtAGlance/diocesan_and_order_lists.htm" target="_blank">two hundred</a> “sexual abuse disclosure” lists published by US Catholic dioceses and religious orders. The Jesuit list is more comprehensive than most like it, but it also contains errors and omissions. For example, sixteen men are named without their dates of abuse. Because <em>Desolate Country</em> relies on the Jesuit list, these men appear on the map, but abuse they committed does not. Because it relies on the list, the map is also limited by (non-public) criteria the Jesuits use to assess “credibility” of accusations.
        </p>
        <p>
          In short, <em>Desolate Country</em> visualizes data produced by a Catholic institution guided by its own interests. With this in mind, we present <em>Desolate Country</em> as both a tool for tracking abuse, and an artifact of problems inherent in all institutional Catholic archives related to abuse.
        </p>
        <p>
